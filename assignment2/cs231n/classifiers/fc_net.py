...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        inp = np.reshape(X, (X.shape[0], -1))
        aff1, aff1_cache = affine_forward(X, self.params['W1'], self.params['b1'])
        relu1, relu1_cache = relu_forward(aff1)
        ...
        drelu = relu_backward(dhidden, relu1_cache)
        dx, grads['W1'], grads['b1'] = affine_backward(drelu, aff1_cache)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dhidden, grads['W' + str(self.num_layers)], grads['b' + str(self.num_layers)] = affine_backward(dscores, affine_cache[str(self.num_layers)])
